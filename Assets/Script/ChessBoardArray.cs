...
public class ChessBoardArray : MonoBehaviour
{
    ...
    public void UpdateArray(){
        ...
        for(int i=0;i<transform.childCount;i++){
            for(int j=0;j<8;j++){
                if(ChessBoard[i].GetChild(j).childCount==1 && ChessBoard[i].GetChild(j).GetChild(0).name=="Bishop(Clone)"){
                    ChessBoard[i].GetChild(j).GetChild(0).GetComponent<EnemyBishop>().ChangeBishopNumber();
                }
                if(ChessBoard[i].GetChild(j).childCount==1 && ChessBoard[i].GetChild(j).GetChild(0).name=="Hetman(Clone)"){
                    ChessBoard[i].GetChild(j).GetChild(0).GetComponent<EnemyHetman>().ChangeHetmanNumber();
                }
                if(ChessBoard[i].GetChild(j).childCount==1 && ChessBoard[i].GetChild(j).GetChild(0).name=="Tower(Clone)"){
